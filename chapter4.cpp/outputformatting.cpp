/*
<ostream> std::endl;
<ostream> std::flush-cause immedaite sending of data to the device connected to stream
<iomanip> std::setw()- koi character kistna wide hoga vo bta rha hi like kabhi data chart banana ho
<ios>     std::right- for right allignment for character
<ios>     std::left - left allignment for character
<ios>     std::internal- sign is left justified while data is right justified
<iomanip>     std::setfill(-)= to fill the character
<ios>     std::boolalpha- output format 1/0- bool condition
<ios>     std::noboolalpha- true/false- to end the boolalpha and again give 1/0 format
<ios>     std::showpos to show positive sign next to number i.e +1 +2 etc
<ios>     std::noshowpos- to cancel show pos
<ios>     std::dec/std::oct/std::hex- to show in different decimal no
( this no system doesnt works on double and floating point no)
<ios>     std::showbase-
<ios>     std::uppercase-std::nouppercase
<ios>     std::scientific- std::fixed ka ulta kar dega // default scientific hi hota hai
<ios>     std::fixed- as man lo 1.34e-10  likh hai  to use no ke form me kar dega
<ios>     std::cout.unsetf(std::ios::scientific | std::ios::fixed);- double values fixed to normal
<iomanip>     std::setprecision()- kisi bhi no ko chota bada fix kar dega- for flaoting point
<ios>std::showpoint/std::noshowpoint - show trailing of zeroes- jitne bhi no hai unke decimal barabr kar dega
...
int main(){
    ...
    //after this std::flush, message has been sent to the stram
    ...
    std::cout<<std::endl;
    std::cout<<"formatted tables with variables"<<std::endl;

    int col_width{14};
    //in real code this is how we shold work
    ...
    std::cout<<std::endl;
    std::cout<<"internal justified table(sign to the left and data to the right)"<<std::endl;
    std::cout<< std::right;
    ...
    //=============================================================
    std::cout<<std::endl;
    //boolalpha and noboolalpha :  control bool output format : 1/0 or true and false

    bool condition{true};
    bool other_conditon{false};
    std::cout<<std::setfill(' ');
    
    std::cout<<std::setw(10)<<"condition : " <<std::setw(10)<<condition <<std::endl;
    std::cout<<std::setw(10)<<"other condtion : "<<std::setw(10)<<other_conditon<<std::endl;

    std::cout<<std::endl;
    std::cout<<std::boolalpha;
    std::cout<<std::setw(10)<<"conditions : " <<std::setw(10)<<condition <<std::endl;
    std::cout<<std::setw(10)<<"other conditions : " <<std::setw(10)<<other_conditon<<std::endl;
    ...
    std::cout<<std::endl;   
     ...
     //only works on integer type number- doesnt work on flaoting point no.
    ...
    std::cout << "double and float will not be affected" <<std::endl;
    ...
    std::cout << "pos_int (hex) : " << std::hex << pos_int << std::endl;
    std::cout << "pos_int (oct) : " << std::oct << pos_int << std::endl;
    //yaha jo no hexadecimal me ab c d aa jata hai to unhe upper case me karne ki bat ho rhai hai
    ...
    std::cout << "b : " << b << std::endl;
    std::cout << "c : " << c << std::endl;
    std::cout<<"a,b,c have precision of 6 bcoz floating poitn has default precision of 6"<<std::endl;
    ...
    std::cout.unsetf(std::ios::scientific | std::ios::fixed); // Hack - this resets to the defaults
    std::cout << "a : " << a << std::endl;
    std::cout << "b : " << b << std::endl;
    std::cout << "c : " << c << std::endl;
