/* 
pointer so far is that 
you shouldn't  assign point without  declaration eg
    int number{12};
    int *p_number = &number;  // this is now its done


    int *p_number; //contain junk address
    int number{12};
    p_number=&number;  this how you shouldn't,
                       its like writing into junk address
    


    1. you shouldn't use pointer which is not initialized
    2. you shouldn't use pointer assigned with null coz it crash 
*/
#include <iostream>
