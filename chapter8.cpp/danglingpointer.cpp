//dangling pointer is a pointer that is doesn't pointing to valid address.
//trying to dereference and use a dangling pointer will result in undefined behavior
//1.unititalized pointer
//2.deleted pointer
//3.multiple pointer pointing to same memory

/*soulutions
1.initialze your pointer
2.reset pointer after deletion
3.for multiple pointer to same address, make sure the owner pointer is very clear 
*/
...
int main(){
   ...
   //p_number1=nullptr; //this clears the address of a pointer 
